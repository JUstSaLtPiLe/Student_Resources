...
namespace StudentResourcesAPI.Migrations
{
    ...
    [Migration("20190102170027_StudentResources_5")]
    partial class StudentResources_5
    {
            ...
            modelBuilder.Entity("StudentResourcesAPI.Models.Grade", b =>
                {
                    ...
                    b.HasKey("AccountId", "SubjectId", "GradeType");

                    b.HasAlternateKey("AccountId", "SubjectId");
